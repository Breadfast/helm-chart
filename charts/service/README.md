...
| monitorService.port | int | `9113` | Kubernetes service port for the monitoring service |
| monitorService.targetPort | int | `9113` | Target port for the monitoring service |
| monitorService.type | string | `"ClusterIP"` | Service type for monitoring, can be either `ClusterIP`, `NodePort`, `LoadBalancer` or `ExternalName` |
